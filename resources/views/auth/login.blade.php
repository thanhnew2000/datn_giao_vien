...
<body
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        ...
        @if (session('error_email'))m-login--forget-password @endif"
                ...
                <div class="m-login__container">
                    ...
                    <div class="m-login__signin">
                        ...
                        <form class="m-login__form m-form" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group m-form__group">
                                <input class="form-control m-input" type="text" placeholder="Tài khoản" name="username"
                                    autocomplete="off">
                            </div>
                            <div class="form-group m-form__group">
                            ...
                            <div class="m-login__form-action">
                                <button type="submit"
                                    class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">ĐĂNG
                                    NHẬP</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="m-login__forget-password">
                        ...
                        <form class="m-login__form m-form" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="m-login__form-action">
                                <button type="submit"
                                    class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn m-login__btn--primaryr">Gửi</button>&nbsp;&nbsp;
